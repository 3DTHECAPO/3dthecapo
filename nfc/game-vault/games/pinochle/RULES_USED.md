...
- 4-player partnership table with 12 cards per seat and no stock.

Fully implemented:
- 48-card invariant: two each of 9, J, Q, K, 10, A in each suit.
- 2-player deal: 12 cards per player and 24-card stock.
- 4-player partnership mode: 12 cards to each of four seats, teams P1/P3 versus P2/P4.
...
- 4-player/team mode has four seats, team trick play, meld scoring, and CPU fill, but not full partnership bidding.
