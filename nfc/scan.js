...
function buildVaultUrl(code){ return '/nfc/index.html?code=' + encodeURIComponent(normalizeCode(code)); }
...
if (enterVault) enterVault.addEventListener('click', () => goWithCode(codeInput.value));
