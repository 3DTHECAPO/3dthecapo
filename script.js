...
if(capoToggle && capoBar){
  capoToggle.addEventListener('click',()=>{
    if(capoBar.style.transform === "translateY(120%)"){
      capoBar.style.transform="translateY(0)";
      capoToggle.innerText="Hide";
    } else {
      capoBar.style.transform="translateY(120%)";
      capoToggle.innerText="Show";
    }
  });
}
